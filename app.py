...
if st.session_state.logs is not None:
    ...
    _verdict_html = (
        ...
        f"</div>"
        f"<div style='position:relative;font-family:DM Mono;font-size:0.58rem;margin-top:5px;'>"
        f"<span style='position:absolute;left:0;color:#ef4444;opacity:0.7;'>Strong ↓</span>"
        f"<span style='position:absolute;left:36%;transform:translateX(-50%);color:#f97316;opacity:0.8;'>Lean ↓</span>"
        f"<span style='position:absolute;left:50%;transform:translateX(-50%);color:#64748b;'>Pass</span>"
        f"<span style='position:absolute;left:64%;transform:translateX(-50%);color:#eab308;opacity:0.8;'>Lean ↑</span>"
        f"<span style='position:absolute;right:0;color:#22c55e;opacity:0.7;'>Strong ↑</span>"
        f"</div>"
